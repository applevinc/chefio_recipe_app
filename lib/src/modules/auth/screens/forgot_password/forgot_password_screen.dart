...
import 'package:chefio_recipe_app/src/modules/auth/screens/forgot_password/confirmation/confirm_forgot_password_screen.dart';
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void submit() async {
    if (_formKey.currentState!.validate()) {
      try {
        await context.read<ForgotPasswordViewModel>().execute(email: emailController.text.trim());
